...
class InitFalkorDBVisualizeBridgeHandler(
    code_action.ActionHandler[
        VisualizeWorkspaceDependencyGraphAction,
        code_action.ActionHandlerConfig,
    ]
):
    """Run init_falkordb before visualizing so FalkorDB is ready.

    Register this handler before VisualizeWorkspaceDependencyGraphHandler. Disable it
