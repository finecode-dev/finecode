...
class ActionExecInfo:
    def __init__(
        ...
        handler_execution: code_action.HandlerExecution = code_action.HandlerExecution.SEQUENTIAL,
    ) -> None:
        ...
        self.handler_execution: code_action.HandlerExecution = handler_execution
