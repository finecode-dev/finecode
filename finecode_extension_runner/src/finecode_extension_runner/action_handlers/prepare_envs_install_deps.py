...
class PrepareEnvsInstallDepsHandler(
    code_action.ActionHandler[prepare_envs_action.PrepareEnvsAction, PrepareEnvsInstallDepsHandlerConfig]
):
        ...
        try:
            async with asyncio.TaskGroup() as tg:
                for env in envs:
                    ...
                    process_raw_deps(env_raw_deps, env_deps_config, dependencies, deps_groups)
