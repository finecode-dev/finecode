...
class HoverDispatchHandlerConfig(code_action.ActionHandlerConfig): ...


class HoverDispatchHandler(
    code_action.ActionHandler[
        TextDocumentHoverAction,
        HoverDispatchHandlerConfig,
    ]
):
    """Dispatch text_document_hover to language-specific subactions.
    ...
    (e.g. TextDocumentHoverPythonAction). If no subaction is registered
