...
class CallHierarchyIncomingCallsDispatchHandlerConfig(code_action.ActionHandlerConfig): ...


class CallHierarchyIncomingCallsDispatchHandler(
    code_action.ActionHandler[
        CallHierarchyIncomingCallsAction,
        CallHierarchyIncomingCallsDispatchHandlerConfig,
    ]
):
    """Dispatch call_hierarchy_incoming_calls to language-specific subactions.
    ...
    (e.g. CallHierarchyIncomingCallsPythonAction). If no subaction is registered
