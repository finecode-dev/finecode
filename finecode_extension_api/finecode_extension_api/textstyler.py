...
class StyledText:
    ...
    def append_styled(self, text: str, foreground: Color | None = None,
        ...
        for param_name, param_default, param_value in params:
            if param_value != param_default:
                changed_params[param_name] = param_value if not isinstance(param_value, enum.Enum) else param_value.value
