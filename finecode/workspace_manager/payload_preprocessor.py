...
def preprocess_for_project(action_name: str, payload: dict[str, typing.Any], project_dir_path: pathlib.Path) -> dict[str, typing.Any]:
    ...
    for param, value in processed_payload.items():
        if param == 'file_paths' and value is None:
            processed_payload['file_paths'] = project_analyzer.get_project_files(project_dir_path)
