...
from finecode.workspace_manager import context, domain, payload_preprocessor, user_messages
from finecode.workspace_manager.runner import manager as runner_manager, runner_client


async def restart_extension_runner(runner_working_dir_path: pathlib.Path, ws_context: context.WorkspaceContext) -> None:
    # TODO: reload config?
    try:
        runner = ws_context.ws_projects_extension_runners[
