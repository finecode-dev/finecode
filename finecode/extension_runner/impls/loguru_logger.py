...
def get_logger():
    # we could implement ilogger.ILogger interface and call loguru methods inside, but loguru takes
    # caller name from `__name__`, so it would be then always this module. To fix this behavior
